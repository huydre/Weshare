...
def staff_required(view_func):
    def wrapper_view(view_instance, request, *args, **kwargs):
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def update(self, request, pk=None):
        ...
        if user_serializer.is_valid():
            user_serializer.save()
            return Response({'message': 'User updated succesfully!', 'data': user_serializer.data},
    ...
    def destroy(self, request, pk=None):
        ...
        if user.is_active == False:
            ...
            return Response({'message': 'User not delected'}, status=status.HTTP_400_BAD_REQUEST)
...
class SearchUserView(APIView):
    def get(self, request):
        ...
        user_search_serializer = SearchUserSerializer(result, many=True)
